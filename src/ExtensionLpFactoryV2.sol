...
/// @notice V2 only requires the LP token to be a known UniswapV2Factory pair.
contract ExtensionLpFactoryV2 is ExtensionFactoryBase, ILpFactory {
    ...
    function createExtension(
        ...
        _validateJoinLpTokenAddress(joinLpTokenAddress);

        extension =
            address(new ExtensionLp(address(this), tokenAddress, joinLpTokenAddress, govRatioMultiplier, minGovRatio));
    ...
    function _validateJoinLpTokenAddress(address joinLpTokenAddress) internal view {
